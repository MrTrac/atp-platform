"""ATP generator stub: report (Step 2 W9-10 staging).

Migration source (AOKP, TypeScript): src/runtime/synthesis/ — answer synthesis + citation grounding (report-shape)
