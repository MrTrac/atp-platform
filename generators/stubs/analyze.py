"""ATP generator stub: analyze (D1.9 staging + D4.3 registry wired).

Migration source (AOKP, TypeScript): src/runtime/eval/ragas/
...
@register_generator(
    ...
    description="RAGAS-shape evaluation synthesis (must-ship)",
...
def run(req: GeneratorRequest) -> SynthesisResult:
    raise NotImplementedError(
        f"ATP generator 'analyze' is a Step 2 W9-10 staging stub. "
