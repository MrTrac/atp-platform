"""ATP generator stub: analyze (Step 2 W9-10 staging).

Migration source (AOKP, TypeScript): src/runtime/eval/ragas/ — RAGAS evaluation (faithfulness + relevancy + precision)
