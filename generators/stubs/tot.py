"""ATP generator stub: tot (D1.9 staging + D4.3 registry wired).

Migration source (AOKP, TypeScript): src/runtime/reasoning/tot/
...
@register_generator(
    ...
    source_aokp_module="src/runtime/reasoning/tot/",
    params_schema={
        "type": "object",
        "properties": {
            "query": {"type": "string"},
...
def run(req: GeneratorRequest) -> SynthesisResult:
    raise NotImplementedError(
        f"ATP generator 'tot' is a Step 2 W9-10 staging stub. "
