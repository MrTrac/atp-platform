"""ATP generator stub: temporal (D1.9 staging + D4.3 registry wired).

Migration source (AOKP, TypeScript): src/runtime/graph/temporal/
...
@register_generator(
    ...
    version="0.1.0",
    lifecycle="draft",
    description="Temporal causal KG synthesis",
    source_aokp_module="src/runtime/graph/temporal/",
    params_schema={
        "type": "object",
        "properties": {
            "query": {"type": "string"},
...
def run(req: GeneratorRequest) -> SynthesisResult:
    raise NotImplementedError(
        f"ATP generator 'temporal' is a Step 2 W9-10 staging stub. "
