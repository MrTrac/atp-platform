"""ATP generator stub: transform (Step 2 W9-10 staging).

Migration source (AOKP, TypeScript): src/runtime/retrieval/ — CRAG + Self-RAG + HyDE (query transform pipeline)
