"""ATP generator stub: graphrag_synth (D1.9 staging + D4.3 registry wired).

Migration source (AOKP, TypeScript): src/runtime/graph/graphrag/
...
@register_generator(
    ...
    description="GraphRAG synthesis (Microsoft pattern)",
    source_aokp_module="src/runtime/graph/graphrag/",
    params_schema={
        "type": "object",
        "properties": {
            "query": {"type": "string"},
...
def run(req: GeneratorRequest) -> SynthesisResult:
    raise NotImplementedError(
        f"ATP generator 'graphrag_synth' is a Step 2 W9-10 staging stub. "
