"""ATP generator stub: graphrag_synth (Step 2 W9-10 staging).

Migration source (AOKP, TypeScript): src/runtime/graph/graphrag/ — GraphRAG synthesis (Microsoft pattern)
