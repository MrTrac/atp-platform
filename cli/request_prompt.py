...
class _RequestPromptCliParser(argparse.ArgumentParser):
...
def _build_parser() -> argparse.ArgumentParser:
    parser = _RequestPromptCliParser(
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "Files written: <export-dir>/<run-id>/request_prompt.json and export_manifest.json"
        ),
    )
    return parser
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.export_dir:
        artifact_path = write_artifact(args.export_dir, args.run_id, "request_prompt", envelope)
