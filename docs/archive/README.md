...
- `reports/` — báo cáo rà soát, consolidation, scope planning, và freeze close-out (ví dụ: `ATP_Docs_Review_Report_VI.md`, `ATP_v0_2_0_Freeze_Closeout.md`, `ATP_v0_4_0_Freeze_Closeout.md`)
