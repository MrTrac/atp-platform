...
This framework defines the rule that important project activities should be governed by explicit templates, not by memory, habit, or ad hoc decisions.
...
Governance artifacts should be stored in a stable path, for example:
